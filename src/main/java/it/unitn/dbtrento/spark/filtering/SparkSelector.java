...
public class SparkSelector {
   ...
   */
  public static Dataset<Row> select(Dataset<Row> data, List<Tuple2<String, String>> whiteList,
   ...
   */
  public static Dataset<Row> applyWhiteList(Dataset<Row> data,
      List<Tuple2<String, String>> whiteList) {
    Dataset<Row> support = data;
    support = support.filter((FilterFunction<Row>) row -> {
   ...
   */
  public static Dataset<Row> applyBlackList(Dataset<Row> data,
      List<Tuple2<String, String>> blackList) {
    Dataset<Row> support = data;
